...
GRANT CONNECT,RESOURCE,UNLIMITED TABLESPACE TO warehouse IDENTIFIED BY 031556;
...
CREATE TABLE BIN_DETAILS ( 
 ...
 INSERT INTO BIN_DETAILS VALUES(01,'WH1');
 INSERT INTO BIN_DETAILS VALUES(02,'WH2');
 INSERT INTO BIN_DETAILS VALUES(03,'WH3');
...
INSERT INTO EMPLOYEE_MASTER VALUES('AVEZ','HUSSAIN','SHUAKAT',040267642,20800,'MANAGER',NULL,'WH1',100);
INSERT INTO EMPLOYEE_MASTER VALUES('LATHEESH','SAI','ERAPALLI',040564732,20800,'MANAGER',NULL,'WH2',101);
INSERT INTO EMPLOYEE_MASTER VALUES('AKSHAY','KALBURGI','AKSHAY',040235532,20800,'MANAGER',NULL,'WH3',102);
...
INSERT INTO EMPLOYEE_MASTER VALUES('Jones','','Wright',040228836,15000,'WORKER',10101,'WH1',106);
INSERT INTO EMPLOYEE_MASTER VALUES('Nikhil','','Gali',040227536,15000,'WORKER',10101,'WH1',107);
INSERT INTO EMPLOYEE_MASTER VALUES('Ravi','Kiran','Soora',040243766,15000,'WORKER',10102,'WH2',108);
INSERT INTO EMPLOYEE_MASTER VALUES('Akhil','Singh','Patan',040245836,15000,'WORKER',10102,'WH2',109);
INSERT INTO EMPLOYEE_MASTER VALUES('Siva','Madhur','Patel',040237436,15000,'WORKER',10102,'WH2',110);
INSERT INTO EMPLOYEE_MASTER VALUES('Prasad','Raju','Konda',040265436,15000,'WORKER',10102,'WH2',111);
INSERT INTO EMPLOYEE_MASTER VALUES('Praneeth','Kumar','Gadam',040236536,15000,'WORKER',10103,'WH3',112);
INSERT INTO EMPLOYEE_MASTER VALUES('Alamsha','','Sheik',040238946,15000,'WORKER',10103,'WH3',113);
INSERT INTO EMPLOYEE_MASTER VALUES('Saravan','','Jha',040238946,15000,'WORKER',10103,'WH3',114);
...
ALTER TABLE EMPLOYEE_MASTER ADD CONSTRAINT FK_EMPLOYEE_UNDER_MANAGER FOREIGN KEY ( EMPLOYEE_NUMBER ) REFERENCES MANAGER_MASTER( EMPLOYEE_NUMBER );
...
COMMENT ON COLUMN WAREHOUSE_MASTER.WAREHOUSE_ID IS 'warehouse id is primary key';
